            ...
            <div className="max-w-7xl mx-auto px-6 md:px-10 pt-10 pb-5">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
                    ...
                    <div className="space-y-3">
                        ...
                        <ul className="space-y-2">
                            <li>
                                <a href="tel:+91-6395139314" className="flex items-center gap-3 text-gray-400 hover:text-white transition-colors">
                                    <Phone size={16}/>
                                    +91-6395139314
                                </a>
                            </li>
                            <li>
                                <a href="mailto:abhinavsharma23102003@gmail.com" className="flex items-center gap-3 text-gray-400 hover:text-white transition-colors">
                                    <Mail size={16}/>
